#!/bin/sh
gdrl --trainer=sf --env=gdrl --env_path=games/Soccer/build/soccer_train.x86_64 --num_workers=10 --experiment_name=Soccer_1 \
 --speedup=12 --num_policies=2 --env_agents=2 --batch_size=2048 --num_batches_per_epoch=2 --batched_sampling=False \
