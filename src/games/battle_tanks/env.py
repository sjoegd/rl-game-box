...
class BattleTanksEnv(gym.Env):
    ...
    def __init__(
        ...
        # TODO: Better observation space (should know angle of own turret etc)
        # Ideas:
        # - Raycast from turret
        # - Give difference angle tank and turret divided by 2pi
    ...
    def step(self, action):
        ...
        observation = self.get_observation(self.tank_1) if not is_human_action else None
    ...
    def get_observation(self, tank: Tank):
        ...
        obs = list(itertools.chain(tile_ray, enemy_ray, rocket_ray, enemy_rocket_ray))
